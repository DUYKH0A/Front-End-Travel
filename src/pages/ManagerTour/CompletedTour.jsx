...
export default function CompletedTour() {
  ...
  const [addDepartureopen, setDepartureOpen] = useState(false);
  ...
  const handleAddDepartureClose = () => setDepartureOpen(false);
          ...
          <Paper sx={{ width: "100%", overflow: "hidden" }}>
            ...
            <Stack direction="row" spacing={2} className="my-2 mb-2">
              <Autocomplete
                ...
                renderInput={(params) => (
                  <TextField {...params} size="small" label="Tìm kiếm tour" />
                )}
              />
              <Typography
                variant="h6"
