    ...
    <div className="tour__card">
      <Card>
        <div className="tour__img">
          ...
          {
            <span>
              {transport} và KS {hotel} <i className="ri-star-fill"></i>
            </span>
          }
        </div>
        ...
        <CardBody>
          <div className="card__top d-flex align-items-center justify-content-between">
            ...
            <h5
              className="tour__title d-flex align-items-center gap-1"
          ...
          <h5 className="tour__title" style={{ fontSize: "18px" }}>
            <i className=""></i>
            <Link to={`/tours/${_id}`}>
              Thời gian khỏi hành: {formattedDepartureDate}
            </Link>
          </h5>
          <div className="card__bottom d-flex align-items-center justify-content-between mt-3">
            <h5>
              Giá: {formatNumber(price)} ₫ <span></span>
            </h5>
          ...
          <div className="card__bottom d-flex align-items-center justify-content-between mt-3">
            <h5>
              <span style={{ color: "black", fontSize: "18px" }}>
                Số chổ còn nhận: {maxGroupSize - numberOfBookings}
              </span>
            </h5>
          </div>
        </CardBody>
